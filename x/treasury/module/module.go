...
//
// The treasury has none: vesting is computed on demand from the schedule rather
// than advanced every block, so a chain with a million locks costs exactly as
// much per block as one with none.
