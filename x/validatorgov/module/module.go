...
//
// Version 2 added operator rotation: two Params fields, the rotation records,
// and an end blocker that acts on them.
...
// EndBlock completes the operator rotations whose delay or challenge window
// ended at this height.
