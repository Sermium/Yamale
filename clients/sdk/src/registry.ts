...
export const CHAIN_MESSAGE_TYPES: ReadonlyArray<[string, GeneratedType]> = [
  ...
  ['/blockchain.alias.v1.MsgRegisterViewingKey', alias.MsgRegisterViewingKey],
  ['/blockchain.alias.v1.MsgRevokeViewingKey', alias.MsgRevokeViewingKey],
  ['/blockchain.alias.v1.MsgAppointRegulator', alias.MsgAppointRegulator],
  ['/blockchain.alias.v1.MsgGrantAuditor', alias.MsgGrantAuditor],
  ['/blockchain.paymsg.v1.MsgSetPayloadStore', paymsg.MsgSetPayloadStore],
