...
export const GenesisState = {
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      poolList: globalThis.Array.isArray(object?.poolList) ? object.poolList.map((e: any) => Pool.fromJSON(e)) : [],
      poolCount: isSet(object.poolCount) ? globalThis.String(object.poolCount) : "0",
    };
  },
  ...
  toJSON(message: GenesisState): unknown {
    ...
    if (message.poolCount !== "0") {
      obj.poolCount = message.poolCount;
    }
    return obj;
  },
